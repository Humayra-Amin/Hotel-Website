 ...
 <section class="section bg-light">
    <div class="container">
      ...
      <div class="row image-container">
        <div class="col-md-6">
            <img src="{{asset('image/swimming pool.jpeg')}}" class="img-fluid fileimg" alt="">
        ...
        <div class="col-md-6">
            <img src="{{asset('image/Spa.jpg')}}" class="img-fluid fileimg" alt="">
  ...
  <section class="section">
    <div class="container">
      <div class="row image-container">
        <div class="col-md-6">
            <img src="{{asset('image/gym (2).jpg')}}" class="img-fluid fileimg" alt="">
        ...
        <div class="col-md-6">
            <img src="{{asset('image/Biliard zone.jpg')}}" class="img-fluid fileimg" alt="">
