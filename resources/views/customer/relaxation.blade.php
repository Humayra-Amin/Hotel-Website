...
@section('apps')
 ...
 <section class="section">
    <div class="container">
      <h1 class="section relaxheading">Relaxation</h1>
      ...
      <div class="row image-container">
        <div class="col-md-6">
          ...
          <h2 class="mt-3 text-center">Swimming Pool</h2>
        ...
        <div class="col-md-6">
          ...
          <h2 class="mt-3 text-center">Spa</h2>
    ...
    <div class="container">
      <div class="row image-container">
        <div class="col-md-6">
          ...
          <h2 class="mt-3 text-center">Gym</h2>
        ...
        <div class="col-md-6">
          ...
          <h2 class="mt-3 text-center">Billiard Zone</h2>
